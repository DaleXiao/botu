...
// head 全套 / sr-only h1 / footer 双语 / robots / sitemap / og-image IHDR / 零外链 / ?v=432 版本化 / gallery 入库
...
test('资产版本化: css/js/favicon/gallery 均带 ?v=432', () => {
  ...
  for (const r of galleryRefs) assert.match(r, /\?v=432$/, r);
});
